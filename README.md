...
Swap in any other Hugging Face encoder (e.g. `roberta-base`) via
`--model_name`.
...
On the public `valid.csv` set (dev-only, not used for final ranking):

| Model | sent-AU | sent-UK | sarc-AU | sarc-UK | **Final score** |
|---|---|---|---|---|---|
| TF-IDF + Logistic Regression | 0.8378 | 0.9116 | 0.7116 | 0.6447 | 0.7413 |
| **distilbert-base-uncased (this repo)** | 0.9106 | 0.9532 | 0.7135 | 0.6374 | **0.7740** |
