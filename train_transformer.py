"""
Stronger baseline for the ALTA 2026 BESSTIE shared task: fine-tunes a
pretrained transformer (default: roberta-base) separately for the
sentiment and sarcasm tasks. Open-source model/weights only.

Usage:
    python train_transformer.py --data_dir data --out answer.csv
    python train_transformer.py --model_name distilbert-base-uncased --epochs 4
"""
...
def main():
    ...
    print("\nTransformer baseline scores on the public valid set (dev-only):")
